...
public class CourseRecordIOTest {
	...
	public void testReadValidCourseRecords() {
		try {
			SortedList<Course> courses2 = CourseRecordIO.readCourseRecords(validTestFile);
			assertEquals(13, courses2.size());
			
			for (int i = 0; i < validCourses.length; i++) {
//				assertEquals(validCourses[i], courses2.get(i).toString());
			}
		} catch (Exception e) {
